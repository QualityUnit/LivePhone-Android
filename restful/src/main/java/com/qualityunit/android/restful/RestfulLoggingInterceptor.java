 ...
 */
public final class RestfulLoggingInterceptor implements Interceptor {
    ...
    public RestfulLoggingInterceptor() {
        this(Logger.DEFAULT);
    }

    public RestfulLoggingInterceptor(Logger logger) {
        this.logger = logger;
    }
    ...
    public RestfulLoggingInterceptor setLevel(Level level) {
